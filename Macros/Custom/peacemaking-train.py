...
def train_peacemaking():
    ...
    while not Dead('self') and Skill('Peacemaking') < skill_cap:
        if Timer('peacemaking_timer') >= peacemaking_timer_milliseconds:
            # Clean skill timers and journal
            ...
            while Timer('peacemaking_timer') < peacemaking_timer_milliseconds:
                ...
                if (InJournal('You play hypnotic music, calming your target.') or
                    InJournal('You play your hypnotic music, stopping the battle.') or
                    InJournal('You attempt to calm everyone, but fail.') or
                    InJournal('You play hypnotic music, but there is nothing in range for you to calm.') or
                    InJournal('You attempt to calm your target, but fail.') or
                    InJournal('You have no chance of calming that creature') or
                    InJournal('You play poorly, and there is no effect.')
                    ):
